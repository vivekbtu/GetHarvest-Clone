...
declare function usePopover(props?: UsePopoverProps): {
    ...
    getArrowProps: _chakra_ui_react_utils.PropGetterV2<"div", _chakra_ui_popper.ArrowCSSVarProps>;
    getArrowInnerProps: _chakra_ui_react_utils.PropGetterV2<"div", {}>;
 ...
 * for the popover.
 */
declare function PopoverAnchor(props: React.PropsWithChildren<{}>): react.DetailedReactHTMLElement<_chakra_ui_utils.Omit<_chakra_ui_react_utils.HTMLProps<any>, never>, HTMLElement>;
...
declare type HTMLMotionChakraProps<T extends keyof react__default.ReactHTML> = Omit<HTMLChakraProps<T>, keyof HTMLMotionProps<T>> & Omit<HTMLMotionProps<T>, "style" | "onDrag" | "onDragEnd" | "onDragStart" | "onAnimationStart" | "variants"> & {
...
}): react.DetailedReactHTMLElement<_chakra_ui_utils.Omit<_chakra_ui_react_utils.HTMLProps<any>, never>, HTMLElement>;
...
declare const usePopoverContext: () => {
    ...
    onAnimationComplete: () => void;
    onClose: () => void;
    getAnchorProps: _chakra_ui_react_utils.PropGetter<any, {}>;
    getArrowProps: _chakra_ui_react_utils.PropGetterV2<"div", _chakra_ui_popper.ArrowCSSVarProps>;
    getArrowInnerProps: _chakra_ui_react_utils.PropGetterV2<"div", {}>;
    getPopoverPositionerProps: _chakra_ui_react_utils.PropGetter<any, {}>;
    getPopoverProps: _chakra_ui_react_utils.PropGetter<any, {}>;
    getTriggerProps: _chakra_ui_react_utils.PropGetter<any, {}>;
    getHeaderProps: _chakra_ui_react_utils.PropGetter<any, {}>;
    getBodyProps: _chakra_ui_react_utils.PropGetter<any, {}>;
};
declare const usePopoverStyles: () => Dict<SystemStyleObject>;
