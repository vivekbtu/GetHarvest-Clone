...
function useCounter(props = {}) {
  const {
    ...
    value: valueProp,
    step: stepProp = 1,
    min = import_utils.minSafeInteger,
    max = import_utils.maxSafeInteger,
  ...
  const [isControlled, value] = (0, import_hooks.useControllableProp)(valueProp, valueState);
  ...
  const clamp = (0, import_react.useCallback)((value2) => {
    ...
    if (keepWithinRange) {
      nextValue = (0, import_utils.clampValue)(nextValue, min, max);
    }
...
function getDecimalPlaces(value, step) {
  return Math.max((0, import_utils.countDecimalPlaces)(step), (0, import_utils.countDecimalPlaces)(value));
}
function cast(value, step, precision) {
  ...
  return (0, import_utils.toPrecision)(parsedValue, precision ?? decimalPlaces);
}
