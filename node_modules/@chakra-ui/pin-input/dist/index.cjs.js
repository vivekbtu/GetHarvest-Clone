...
var [PinInputProvider, usePinInputContext] = (0, import_react_utils.createContext)({
...
function usePinInput(props = {}) {
  ...
  const [values, setValues] = (0, import_hooks.useControllableState)({
  ...
  (0, import_react2.useEffect)(() => {
    if (autoFocus) {
      ...
      if (first)
        (0, import_utils.focus)(first.node, { nextTick: true });
    }
  }, [descendants]);
  const focusNext = (0, import_react2.useCallback)((index) => {
    ...
    if (next)
      (0, import_utils.focus)(next.node, { nextTick: true });
  }, [descendants, moveFocus, manageFocus]);
  const setValue = (0, import_react2.useCallback)((value2, index) => {
  ...
  const getInputProps = (0, import_react2.useCallback)((props2) => {
    ...
    const onKeyDown = (event) => {
      if (event.key === "Backspace" && manageFocus) {
        if (event.target.value === "") {
          ...
          if (prevInput) {
            setValue("", index - 1);
            (0, import_utils.focus)(prevInput.node);
            setMoveFocus(true);
          }
        } else {
          setMoveFocus(false);
    ...
    return {
      ...
      onChange: (0, import_utils.callAllHandlers)(rest.onChange, onChange2),
      onKeyDown: (0, import_utils.callAllHandlers)(rest.onKeyDown, onKeyDown),
      onFocus: (0, import_utils.callAllHandlers)(rest.onFocus, onFocus),
      onBlur: (0, import_utils.callAllHandlers)(rest.onBlur, onBlur),
      value: values[index] || "",
...
function usePinInputField(props = {}, ref = null) {
  ...
  return getInputProps({
    ...props,
    ref: (0, import_react_utils.mergeRefs)(register, ref),
    index
  });
}
...
function PinInput(props) {
  ...
  const clones = (0, import_react_utils2.getValidChildren)(children).map((child) => (0, import_react3.cloneElement)(child, { __css: styles }));
...
var PinInputField = (0, import_system.forwardRef)(function PinInputField2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system.chakra.input, {
    ...inputProps,
    className: (0, import_utils2.cx)("chakra-pin-input", props.className)
  });
});
if (import_utils2.__DEV__) {
