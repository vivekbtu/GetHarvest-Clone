...
var Skeleton = (0, import_system.forwardRef)((props, ref) => {
  ...
  const wasPreviouslyLoaded = (0, import_hooks.usePrevious)(isLoaded);
  const _className = (0, import_utils.cx)("chakra-skeleton", className);
  if (isLoaded) {
...
var SkeletonText = (props) => {
  ...
  const _className = (0, import_utils.cx)("chakra-skeleton__group", className);
  return /* @__PURE__ */ import_react.default.createElement(import_system.chakra.div, {
    className: _className,
    ...rest
