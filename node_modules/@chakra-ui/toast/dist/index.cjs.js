...
function createRenderToast(options = {}) {
  ...
  const renderToast = (props) => {
    if ((0, import_utils.isFunction)(render)) {
      return render(props);
    }
...
function createToastFn(dir, defaultOptions) {
  ...
  toast.promise = (promise, options) => {
    ...
    promise.then((data) => toast.update(id, {
      status: "success",
      duration: 5e3,
      ...(0, import_utils.runIfFn)(options.success, data)
    })).catch((error) => toast.update(id, {
      status: "error",
      duration: 5e3,
      ...(0, import_utils.runIfFn)(options.error, error)
    }));
  };
...
var ToastComponent = (0, import_react3.memo)((props) => {
  ...
  (0, import_hooks.useTimeout)(close, delay);
  ...
  }, (0, import_utils2.runIfFn)(message, { id, onClose: close })));
});
...
var ToastProvider = (props) => {
  ...
  const toastList = (0, import_utils3.objectKeys)(state).map((position) => {
