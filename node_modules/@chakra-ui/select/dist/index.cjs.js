...
var SelectField = (0, import_system.forwardRef)(function SelectField2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system.chakra.select, {
    ...rest,
    ref,
    className: (0, import_utils.cx)("chakra-select", className)
...
var Select = (0, import_system.forwardRef)((props, ref) => {
  const styles = (0, import_system.useMultiStyleConfig)("Select", props);
  const {
    rootProps,
    placeholder,
    icon,
  ...
  const [layoutProps, otherProps] = (0, import_utils.split)(rest, import_system.layoutPropNames);
  ...
  const fieldStyles = (0, import_utils.mergeWith)({ paddingEnd: "2rem" }, styles.field, { _focus: { zIndex: "unset" } });
  return /* @__PURE__ */ import_react.default.createElement(import_system.chakra.div, {
    ...
    "data-disabled": (0, import_utils.dataAttr)(ownProps.disabled),
...
var IconWrapper = (0, import_system.chakra)("div", {
  baseStyle: {
    position: "absolute",
    display: "inline-flex",
    alignItems: "center",
