...
function useFormControlProvider(props) {
  ...
  const uuid = (0, import_hooks.useId)();
  ...
  const [isFocused, setFocus] = (0, import_hooks.useBoolean)();
...
var FormControl = (0, import_system.forwardRef)(function FormControl2(props, ref) {
  ...
  const className = (0, import_utils.cx)("chakra-form-control", props.className);
...
var FormHelperText = (0, import_system.forwardRef)(function FormHelperText2(props, ref) {
  ...
  const className = (0, import_utils.cx)("chakra-form__helper-text", props.className);
...
function useFormControl(props) {
  ...
  return {
    ...
    readOnly: isReadOnly,
    required: isRequired,
    "aria-invalid": (0, import_utils2.ariaAttr)(isInvalid),
    "aria-required": (0, import_utils2.ariaAttr)(isRequired),
    "aria-readonly": (0, import_utils2.ariaAttr)(isReadOnly)
  };
}
function useFormControlProps(props) {
  ...
  return {
    ...
    onFocus: (0, import_utils2.callAllHandlers)(field == null ? void 0 : field.onFocus, onFocus),
    onBlur: (0, import_utils2.callAllHandlers)(field == null ? void 0 : field.onBlur, onBlur)
  };
}

// src/form-error.tsx
var import_icon = __toESM(require("@chakra-ui/icon"));
var import_react_utils2 = require("@chakra-ui/react-utils");
var import_system2 = require("@chakra-ui/system");
var import_utils3 = require("@chakra-ui/utils");
var [FormErrorStylesProvider, useFormErrorStyles] = (0, import_react_utils2.createContext)({
...
var FormErrorMessage = (0, import_system2.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(FormErrorStylesProvider, {
    ...
    className: (0, import_utils3.cx)("chakra-form__error-message", props.className),
    __css: {
      display: "flex",
      alignItems: "center",
      ...styles.text
...
var FormErrorIcon = (0, import_system2.forwardRef)((props, ref) => {
  ...
  if (!(field == null ? void 0 : field.isInvalid))
    return null;
  const _className = (0, import_utils3.cx)("chakra-form__error-icon", props.className);
...
var FormLabel = (0, import_system3.forwardRef)(function FormLabel2(passedProps, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system3.chakra.label, {
    ...ownProps,
    className: (0, import_utils4.cx)("chakra-form__label", props.className),
    __css: {
      display: "block",
      textAlign: "start",
      ...styles
...
var RequiredIndicator = (0, import_system3.forwardRef)(function RequiredIndicator2(props, ref) {
  ...
  if (!(field == null ? void 0 : field.isRequired))
    return null;
  const className = (0, import_utils4.cx)("chakra-form__required-indicator", props.className);
