...
var [ButtonGroupProvider, useButtonGroup] = (0, import_react_utils.createContext)({
  strict: false,
...
function ButtonIcon(props) {
  ...
  const _className = (0, import_utils.cx)("chakra-button__icon", className);
...
function ButtonSpinner(props) {
  ...
  const _className = (0, import_utils2.cx)("chakra-button__spinner", className);
...
var Button = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const buttonStyles = (0, import_react5.useMemo)(() => {
    const _focus = (0, import_utils3.mergeWith)({}, (styles == null ? void 0 : styles["_focus"]) ?? {}, { zIndex: 1 });
    return {
      display: "inline-flex",
      appearance: "none",
      alignItems: "center",
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system3.chakra.button, {
    ...
    ref: (0, import_hooks.useMergeRefs)(ref, _ref),
    as,
    type: type ?? defaultType,
    "data-active": (0, import_utils3.dataAttr)(isActive),
    "data-loading": (0, import_utils3.dataAttr)(isLoading),
    __css: buttonStyles,
    className: (0, import_utils3.cx)("chakra-button", className),
    ...rest
...
var ButtonGroup = (0, import_system4.forwardRef)(function ButtonGroup2(props, ref) {
  ...
  const _className = (0, import_utils4.cx)("chakra-button__group", className);
