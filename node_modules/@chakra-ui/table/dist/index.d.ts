...
declare const useTableStyles: () => Dict<SystemStyleObject>;

interface TableContainerProps extends HTMLChakraProps<"div"> {
}
declare const TableContainer: _chakra_ui_system.ComponentWithAs<"div", TableContainerProps>;
interface TableProps extends HTMLChakraProps<"table">, ThemingProps<"Table"> {
}
...
declare const Tfoot: _chakra_ui_system.ComponentWithAs<"tfoot", TableFooterProps>;
...
export { Table, TableBodyProps, TableCaption, TableCaptionProps, TableCellProps, TableColumnHeaderProps, TableContainer, TableContainerProps, TableFooterProps, TableHeadProps, TableProps, TableRowProps, Tbody, Td, Tfoot, Th, Thead, Tr, useTableStyles };
