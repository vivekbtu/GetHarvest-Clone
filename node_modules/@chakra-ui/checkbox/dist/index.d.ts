...
import { ThemingProps, SystemProps, HTMLChakraProps, PropsOf } from '@chakra-ui/system';
import * as react from 'react';
import * as _chakra_ui_utils from '@chakra-ui/utils';
import { Dict, Omit as Omit$1 } from '@chakra-ui/utils';
...
declare type CheckboxControlProps = Omit$1<HTMLChakraProps<"div">, keyof UseCheckboxProps>;
...
declare function useCheckbox(props?: UseCheckboxProps): {
    ...
    htmlProps: _chakra_ui_utils.Omit<{
        isDisabled?: boolean | undefined;
    ...
    }, "isDisabled" | "id" | "aria-describedby" | "onFocus" | "onBlur" | "isReadOnly" | "isRequired" | "isInvalid">;
};
declare type UseCheckboxReturn = ReturnType<typeof useCheckbox>;

export { Checkbox, CheckboxGroup, CheckboxGroupContext, CheckboxGroupProps, CheckboxProps, CheckboxState, UseCheckboxGroupProps, UseCheckboxGroupReturn, UseCheckboxProps, UseCheckboxReturn, useCheckbox, useCheckboxGroup };
