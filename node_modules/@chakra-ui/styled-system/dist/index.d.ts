...
declare type CSSMap = Dict<{
    value: string;
    var: string;
    varRef: string;
}>;
declare type Transform = (value: any, theme: CssTheme, styles?: Dict) => any;
...
declare function toCSSVar<T extends Dict>(rawTheme: T): WithCSSVar<T>;
...
declare function getCss(options: GetCSSOptions): (stylesOrFn: Dict, nested?: boolean) => Dict<any>;
declare const css: (styles: StyleObjectOrFn) => (theme: CssTheme) => Dict<any>;

declare type Theme = WithCSSVar<Dict>;
declare type Config = {
    parts?: string[];
    baseStyle?: Dict;
    variants?: Dict;
...
declare const propNames: (string | number | symbol)[];
declare const isStyleProp: (prop: string) => boolean;

declare const tokenToCSSVar: (scale: ThemeScale, value: any) => (theme: Dict) => any;
...
interface MultiStyleConfig<T extends Anatomy = Anatomy> {
...
declare type PartsStyleObject<T extends Anatomy = Anatomy> = Partial<Record<T["__type"], SystemStyleObject>>;
declare type PartsStyleFunction<T extends Anatomy = Anatomy> = (props: StyleFunctionProps) => PartsStyleObject<T>;
declare type PartsStyleInterpolation<T extends Anatomy = Anatomy> = PartsStyleObject<T> | PartsStyleFunction<T>;
