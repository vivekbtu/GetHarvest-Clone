...
function getProgressProps(options) {
  ...
  const getAriaValueText = () => {
    if (value == null)
      return void 0;
    return (0, import_utils.isFunction)(getValueText) ? getValueText(value, percent) : valueText;
  };
  return {
    bind: {
...
// src/circular-progress.tsx
var Circle = (props) => /* @__PURE__ */ import_react.default.createElement(import_system2.chakra.circle, {
  cx: 50,
  cy: 50,
  r: 42,
  fill: "transparent",
...
var CircularProgressLabel = (0, import_system2.chakra)("div", {
  baseStyle: {
    fontSize: "0.24em",
    top: "50%",
    left: "50%",
...
var [ProgressStylesProvider, useProgressStyles] = (0, import_react_utils.createContext)({
...
var Progress = (props) => {
  ...
  const styles = (0, import_system3.useMultiStyleConfig)("Progress", props);
