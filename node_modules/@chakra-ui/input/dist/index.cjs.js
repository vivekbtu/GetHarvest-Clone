...
var Input = (0, import_system.forwardRef)(function Input2(props, ref) {
  ...
  const _className = (0, import_utils.cx)("chakra-input", props.className);
...
var [InputGroupStylesProvider, useInputGroupStyles] = (0, import_react_utils.createContext)({
...
var InputGroup = (0, import_system2.forwardRef)(function InputGroup2(props, ref) {
  ...
  const _className = (0, import_utils2.cx)("chakra-input__group", className);
  const groupStyles = {};
  ...
  const clones = validChildren.map((child) => {
    var _a, _b;
    const theming = (0, import_utils2.filterUndefined)({
...
var InputLeftAddon = (0, import_system3.forwardRef)(function InputLeftAddon2(props, ref) {
  return /* @__PURE__ */ import_react.default.createElement(InputAddon, {
    ...
    placement: "left",
    ...props,
    className: (0, import_utils3.cx)("chakra-input__left-addon", props.className)
  });
});
if (import_utils3.__DEV__) {
...
var InputRightAddon = (0, import_system3.forwardRef)(function InputRightAddon2(props, ref) {
  return /* @__PURE__ */ import_react.default.createElement(InputAddon, {
    ...
    placement: "right",
    ...props,
    className: (0, import_utils3.cx)("chakra-input__right-addon", props.className)
  });
});
if (import_utils3.__DEV__) {
...
var InputLeftElement = (0, import_system4.forwardRef)(function InputLeftElement2(props, ref) {
  ...
  const _className = (0, import_utils4.cx)("chakra-input__left-element", className);
...
var InputRightElement = (0, import_system4.forwardRef)(function InputRightElement2(props, ref) {
  const { className, ...rest } = props;
  const _className = (0, import_utils4.cx)("chakra-input__right-element", className);
  return /* @__PURE__ */ import_react.default.createElement(InputElement, {
    ref,
    placement: "right",
    className: _className,
