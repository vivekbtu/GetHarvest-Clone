...
var Switch = (0, import_system.forwardRef)(function Switch2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system.chakra.label, {
    ...getRootProps(),
    className: (0, import_utils.cx)("chakra-switch", props.className),
    ...
    "data-checked": (0, import_utils.dataAttr)(state.isChecked),
    "data-hover": (0, import_utils.dataAttr)(state.isHovered)
