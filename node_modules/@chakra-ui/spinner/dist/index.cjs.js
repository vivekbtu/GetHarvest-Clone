...
var Spinner = (0, import_system.forwardRef)((props, ref) => {
  ...
  const _className = (0, import_utils.cx)("chakra-spinner", className);
  const spinnerStyles = {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system.chakra.div, {
    ...
    ...rest
  }, label && /* @__PURE__ */ import_react.default.createElement(import_visually_hidden.VisuallyHidden, null, label));
});
