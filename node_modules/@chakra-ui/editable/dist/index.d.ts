...
declare function useEditable(props?: UseEditableProps): {
    ...
    getInputProps: PropGetterV2<"input", HTMLChakraProps<"input">>;
    getTextareaProps: PropGetterV2<"textarea", HTMLChakraProps<"textarea">>;
...
declare function useEditableControls(): {
    isEditing: boolean;
    getEditButtonProps: _chakra_ui_react_utils.PropGetter<any, {}>;
    getCancelButtonProps: _chakra_ui_react_utils.PropGetter<any, {}>;
    getSubmitButtonProps: _chakra_ui_react_utils.PropGetter<any, {}>;
};
...
declare const useEditableStyles: () => Dict<SystemStyleObject>;
